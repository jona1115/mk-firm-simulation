...
cfg = create_configuration(SIM_DURATION_MS, "simso.schedulers.MK_RMS")
...
# Task set 3 (aka "task set 3" in project report), below task set is 200% utilization
...
# Task set 4 (aka "task set 2" in project report), below task set is 117% utilization
# cfg.add_task(name="T1", identifier=1,   period=10,  wcet=1,     deadline=10,    m=2, k=3)
# cfg.add_task(name="T2", identifier=2,   period=12,  wcet=3,     deadline=12,    m=1, k=2)
# cfg.add_task(name="T3", identifier=3,   period=9,   wcet=6,     deadline=9,     m=2, k=5)
# cfg.add_task(name="T4", identifier=4,   period=20,  wcet=2,     deadline=20,    m=3, k=7)

# Task set 5 (aka "task set 1" in project report), below task set is 98% utilization
cfg.add_task(name="T1", identifier=1,   period=10,  wcet=1,     deadline=10,    m=2, k=3)
cfg.add_task(name="T2", identifier=2,   period=12,  wcet=5,     deadline=12,    m=1, k=2)
cfg.add_task(name="T3", identifier=3,   period=9,   wcet=2,     deadline=9,     m=2, k=5)
cfg.add_task(name="T4", identifier=4,   period=25,  wcet=1,     deadline=25,    m=3, k=7)
cfg.add_task(name="T5", identifier=5,   period=5,   wcet=1,     deadline=5,     m=4, k=7)
