...
cfg.add_task(name="T1", identifier=1, period=20, wcet=5, deadline=20, m=2, k=5)       # 25%, period, deadline unit in ms
cfg.add_task(name="T2", identifier=2, period=50, wcet=10, deadline=50, m=3, k=9)      # 20%
cfg.add_task(name="T3", identifier=3, period=100, wcet=15, deadline=100, m=1, k=4)    # 15%
cfg.add_task(name="T4", identifier=4, period=10, wcet=2, deadline=10, m=1, k=3)       # 20%
cfg.add_task(name="T5", identifier=5, period=30, wcet=6, deadline=30, m=2, k=3)       # 20%
...
# cfg.scheduler_info.clas = "simso.schedulers.EDF_Better"
